<div class="p-6 max-w-6xl mx-auto mb-6 border  p-6 mt-4 bg-white shadow lg:max-w-2xl rounded-xl space-y-6">
    <div class="space-y-4">
      ...
      <div class="flex justify-between ">
        ...
        <div class="flex justify-between ">
           ...
           @if($a)
            <div class="space-y-4 border rounded-lg mt-4  px-4 mb-4 py-4">
           ...
           @endif
          @if($v)
            <div class="space-y-4 border rounded-lg px-4 mb-2 py-4 mt-4 mb-4">
    ...
    <div>
          <div class="bg-white shadow ">
            ...
            <x-map-picker :lat="12.322" :lng="15.1410" :editable="true" />
        </div>
        <div class="space-y-4 border rounded-lg px-4 mb-2 py-4 mt-4 mb-4">
            <div  class="flex flex-row justify-between  ">
                ...
                <div class="">
                    ...
                    <textarea wire:model="description" class="mx-2 input rounded w-full input-bordere" cols="10" rows="6"></textarea>
                </div>
              </div>
        </div>
    </div>
