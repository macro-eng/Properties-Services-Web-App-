    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gradient-to-b from-orange-600 to-amber-500  flex flex-col shadow-lg">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="/company/services/list" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                ...
                <a href="/company/profile/list" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
