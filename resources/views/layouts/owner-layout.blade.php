    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gradient-to-b from-orange-600 to-amber-500  flex flex-col shadow-lg">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="/owner/dashboard" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                    📊 <span class="mr-2">لوحة التحكم</span>
                </a>
                <a href="/owner/services/" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                    🛠️ <span class="mr-2">الخدمات</span>
                </a>
                <a href="/owner/requests" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                    📥 <span class="mr-2">الطلبات</span>
                </a>
                <a href="/owner/property/list" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                     🏢  <span class="mr-2">عقارتي</span>
                </a>  
                <a href="/owner/company" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                     🏢  <span class="mr-2">الشركات</span>
                </a>
                <a href="/owner/bookings" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                    💰 <span class="mr-2">الحجوزات</span>
                </a>   <a href="/owner/payments" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                    💰 <span class="mr-2">المدفوعات</span>
                </a>
                <a href="/owner/reports" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
                    📈 <span class="mr-2">التقارير</span>
                </a>
                <a href="/owner/profile" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-400 transition">
